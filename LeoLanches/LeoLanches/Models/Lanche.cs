...
public class Lanche
{
    ...
    [MinLength(20, ErrorMessage = "Descrição detalhada do lanche deve ter no mínimo {1} caracteres")]
    [MaxLength(200, ErrorMessage = "Descrição detalhada do lanche deve ter no máximo {1} caracteres")]
